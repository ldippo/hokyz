...
export const RIVALS: RivalTeam[] = [
  ...
  { id: 'gators', name: 'Bayou Gators', short: 'GATORS', color: '#3d8f3d', gimmick: 'Swamp goalie. +20% saves, half the rebounds.', lineup: ['playmaker', 'enforcer', 'dangler'], tierBonus: 0, mods: (m) => { mulMod(m, 'goalieSaveMul', 1.2); mulMod(m, 'reboundMul', 0.5); } },
