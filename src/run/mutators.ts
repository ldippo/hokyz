...
export const MUTATORS: Mutator[] = [
  ...
  { id: 'fight_night', name: 'Fight Night', desc: 'More fights: up to three per period while both teams have spare skaters.', apply: (mm) => { mm.fightsPerPeriod = 3; for (const t of mm.teams) mulMod(t, 'temperMul', 3); } },
