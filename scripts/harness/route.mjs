...
writeFileSync(join(out,'report.json'),JSON.stringify({pass:!errors.length,checks,checkpoints,errors,scope:'Generated map links preserved; first three encounter types and initial injuries prepared. Real choices, purchases, training and reload; not complete-run combat evidence.'},null,2));
