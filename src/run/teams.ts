...
export const RIVALS: RivalTeam[] = [
  ...
  { id: 'boss_blur', name: 'Velocity Blur', short: 'BLUR', color: '#00e5ff', gimmick: 'BOSS. Infinite turbo, +15% speed.', lineup: ['speedster', 'speedster', 'sniper'], tierBonus: 2, boss: true, act: 2, mods: (m) => { mulMod(m, 'speedMul', 1.15); mulMod(m, 'turboDrainMul', 0.01); }, phases: [{ period: 2, kind: 'slickIce', label: 'ICE STORM', desc: 'Period 2 onward: less grip and easier knockdowns for both teams. Turn early and check the Blur off the puck.' }, { period: 3, kind: 'turboAll', label: 'REDLINE', desc: 'Period 3 onward: your turbo is unlimited too. Keep turbo held while skating to close the gap.' }] },
